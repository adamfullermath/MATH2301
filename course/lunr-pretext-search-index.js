...
},
{
  ...
  "number": "",
  "title": "Recitation 2",
  "body": " Recitation 2    Instructions: fill in the appropriate answers in the spaces below.   Clearly write first and last names of each member on the top of the pages.      We will use the Squeeze Theorem to show      Find functions and such that          To apply the Squeeze Theorem we need Calculate (If go back and choose different and .)  Put your work for calculating and in the space below.      Apply the Squeeze Theorem to calculate          In this exercise you will use the Intermediate Value Theorem to study the roots of polynomials.     Use the Intermediate Value Theorem to show that the function has a root. That is, show that there is a solution to . (You do not have to find the root).      Let be any polynomial of degree . Explain why must have at least one root.      Let be any polynomial of odd degree. Explain why must have at least one root.      Does the same argument work for polynomials of even degree?      "
},
{
  "id": "ch--3-3-1",
  "level": "2",
  "url": "ch--3.html#ch--3-3-1",
  "type": "Worksheet Exercise",
  "number": "1",
  "title": "",
  "body": "  We will use the Squeeze Theorem to show      Find functions and such that          To apply the Squeeze Theorem we need Calculate (If go back and choose different and .)  Put your work for calculating and in the space below.      Apply the Squeeze Theorem to calculate     "
},
{
  "id": "ch--3-4-1",
  "level": "2",
  "url": "ch--3.html#ch--3-4-1",
  "type": "Worksheet Exercise",
  "number": "2",
  "title": "",
...
},
{
  "id": "root-1-2-5-2-3-1",
  "level": "2",
  "url": "root-1-2-5-2.html#root-1-2-5-2-3-1",
  "type": "Worksheet Exercise",
  "number": "1",
  "title": "",
  "body": "  Below is the graph of .    Plot of a piecewise defined function.         Fill in the answers based on the graph.            List the points where is not continuous. Which of these points are jump discontinuities ? Which of these points are removable discontinuities ?    The function is not continuous at , , and . Jump discontinuities at and . Removable discontinuity at     "
},
{
  "id": "root-1-2-5-2-4-1",
  "level": "2",
  "url": "root-1-2-5-2.html#root-1-2-5-2-4-1",
  "type": "Worksheet Exercise",
  "number": "2",
  "title": "",
...
},
{
  ...
  "number": "5",
  "title": "",
  "body": "  Let . Use the definition of the derivative (i.e. the limit formula for derivatives) to calculate .    The derivative is given by, Thus, That is, Evaluating at we have     We can evaluate directly, without first finding  Using and Hence That is,    "
},
{
  "id": "root-1-2-6-2-6-2",
  "level": "2",
